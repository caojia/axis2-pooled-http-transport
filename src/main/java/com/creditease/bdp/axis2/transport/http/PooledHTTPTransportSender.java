...
public class PooledHTTPTransportSender extends AbstractHandler implements
        TransportSender {
    /**
     * The {@link org.apache.axis2.description.TransportOutDescription} object received by the call to
     * {@link #init(org.apache.axis2.context.ConfigurationContext, org.apache.axis2.description.TransportOutDescription)}.
     */
     ...
     * message basis using the {@link org.apache.axis2.transport.http.HTTPConstants#HTTP_PROTOCOL_VERSION} property.
     */
    ...
    public void init(ConfigurationContext confContext,
        ...
        // NOTE: Added by CJ
        try {
            Parameter maxConnectionsPerHostParam = transportOut.
                    getParameter(com.creditease.bdp.axis2.transport.http.Constants.MAX_CONNECTIONS_PER_HOST);

            if (maxConnectionsPerHostParam != null) {
                maxConnectionsPerHost = Integer.parseInt((String) maxConnectionsPerHostParam.
                        getValue());
            }
